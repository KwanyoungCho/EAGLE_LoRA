...
TRAIN_DATA_PATH="/home/chokwans99/LoRA_Eagle/EAGLE_LoRA/myDatasets/wmt16_en_de_0_29999_mufp16"

CHECKPOINT_DIR="checkpoints/wmt16_lora_$(date +%Y%m%d_%H%M%S)"  # 체크포인트 저장 경로
