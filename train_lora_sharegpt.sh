...
# 17번 서버
BASE_MODEL_PATH="/home/chokwans99/LoRA_Eagle/EAGLE_LoRA/mymodels/vicuna-7b-v1.3"  # 베이스 모델 경로 (LLaMA, Qwen 등)
EAGLE_MODEL_PATH="yuhuili/EAGLE-Vicuna-7B-v1.3"  # 사전 학습된 EAGLE 모델 경로
CONFIG_PATH="/home/chokwans99/LoRA_Eagle/EAGLE_LoRA/mymodels/vicuna-7b-v1.3"  # 설정 파일 경로
TRAIN_DATA_PATH="/home/chokwans99/LoRA_Eagle/EAGLE_LoRA/myDatasets/sharegpt_0_4999_mufp16"  # 학습 데이터 경로

CHECKPOINT_DIR="checkpoints/sharegpt_lora_$(date +%Y%m%d_%H%M%S)"  # 체크포인트 저장 경로

# 학습 관련 설정
LEARNING_RATE=3e-5
BATCH_SIZE=4  # 단일 GPU에서 실행할 배치 사이즈
...
export WANDB_ENTITY="chaile9983"  # 여기에 본인의 wandb 사용자명 입력
export WANDB_PROJECT="eagle-lora"  # 원하는 프로젝트명 입력
export WANDB_API_KEY=9a1cf9bbe01f0e46f67c32e2c5822dd905e5a6f4
